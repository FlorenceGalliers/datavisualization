...
plot1 <- ggplot(meat_edit, 
  ...
  coord_flip() +
  labs(title = "Argentinian Beef emissions are over 30x higher than consumption levels",
       subtitle = "Points show the difference between the carbon emissions produced (kg CO2/person/year) by meat production, and the level of 
consumption of those meats (kg/person/year) in each country. The further to the right a point is, the higher the emissions are in 
comparison to consumption.") +
  ylab("Difference between emissions and consumptions (kg/person/year)") +
