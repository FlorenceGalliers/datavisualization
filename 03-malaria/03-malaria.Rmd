...
ggplot(africa_inc, aes(x = Year, 
  ...
  geom_line(data = africa_inc_high, color = "red") +
  geom_line(data = africa_inc_low, color = "green") +
  coord_trans(clip = "off") +
  theme_minimal() +
  geom_text(data = subset(africa_inc_high, Year == 2015), 
            aes(label = Entity),
            color = "red", 
            x = 2016,
            y = incidence) +
  labs(title = "Disparity in Malaria Incidence Rates throughout Africa",
...
africa_inc_wide[28, ] # mali
africa_inc_wide[5, ] # burkina faso
africa_inc_wide[33, ] # nigeria
