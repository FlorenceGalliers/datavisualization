...
plot(co2_emmission ~ consumption, data = top10,
     pch = 16,
     col = "red")
points(top10$consumption,
       pch = 1,
       col = "green")
...
food_plot$pal <- as.factor(food_plot$pal)
food_plot$continent <- factor(food_plot$continent)
