...
age_groups <- c("Under 5", "5-14", "15-49", "50-69", "70 or older")

years <- seq(1990, 2016, 1)

# write plot into png file, 20cm x 20cm, resolution 300 dpi.
...
# add rectangles and text for legend instead
rect(4, 3, 8, 4, 
     col = palette[1])
rect(9, 3, 13, 4, 
     col = palette[2])
