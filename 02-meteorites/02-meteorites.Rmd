...
ggplot(top20c,
       aes(x = reorder(name, mass), y = mass,
           fill = class)) +
  geom_segment(aes(x = reorder(name, mass), xend = name, 
                   y = 0, yend = mass,
                   color = class),
               size = 3, alpha = 0.2) +
    geom_segment(aes(x = reorder(name, mass), xend = name, 
                   ...
                   color = class),
               size = 1, alpha = 0.8) +
  geom_flag(aes(x = reorder(name, mass), y = 0, 
