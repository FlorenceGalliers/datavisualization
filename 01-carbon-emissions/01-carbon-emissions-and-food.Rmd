...
xlabels <- c("Dairy", "Wheat", "Rice", "Poultry", "Fish", "Beef", "Eggs", "Nuts", "Lamb/Goat", "Pork", "Soybeans")
...
text(x = 5, y = 300,
     expression("Europe "*phantom("leads the way on dairy consumption")),
     col = palette[4],
     size = 2)
text(x = 5, y = 300,
     expression(phantom("Europe ")*"leads the way on dairy consumption"),
     col = "black",
     size = 2)
