...
boxplot(consumption ~ reorder(food_category, -consumption), 
        ...
        frame = F) # remove frame box around plot

# add title to plot, and x and y axis labels
title("Dairy, wheat and rice products are among the most widely eaten foods worldwide",
      family = "Avenir",
      ylab = "Consumption (kg/person/year)",
      xlab = "Food Category")
...
axis(1, at = c(1, 2.5, 4, 5.5, 7, 8.5, 10, 11.5, 13, 14.5, 16), 
     ...
     cex.axis = 0.8, family = "Avenir", # font size and style
     tick = F, # remove tick marks
     line = -1.8 # move x axis labels up towards plot
     )
