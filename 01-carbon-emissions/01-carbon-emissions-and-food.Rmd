...
boxplot(consumption ~ reorder(food_category, -consumption), 
        ...
        outline = F,
        pch = 1,
        xlim = c(0.5, 11.5), ylim = c(0, 350),
        col = "grey95", medcol = "grey60", whiskcol = "grey60", 
        staplecol = "grey60", boxcol = "grey60", outcol = "grey60",
        lwd = 0.5)
title("Dairy, Wheat and Rice products are among the most widely each foods worldwide",
      family = "Didot Bold")
