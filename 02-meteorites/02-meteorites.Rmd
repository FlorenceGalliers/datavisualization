...
ggplot(top20,
       aes(x = reorder(name, mass),
           ...
           fill = class,
           label = mass)) +
  geom_segment(aes(x = reorder(name, mass), 
                   xend = name, 
                   y = 0, 
                   yend = mass),
               colour = "white",
    ...
    geom_segment(aes(x = reorder(name, mass), 
               ...
               size = 1,
               alpha = 0.8) +
  geom_flag(aes(x = reorder(name, mass), 
                y = -2, 
  ...
  coord_flip() +
  labs(title = "WHERE HAVE THE LARGEST METEORITES FALLEN?",
    y = "Mass (tonnes)",
       x = "") +
  theme_minimal()+
  theme(
    axis.text.y = element_text(hjust = 0,
                               colour = "white",
                               family = "Avenir"),
    plot.background = element_rect(fill = "#003f5c"),
