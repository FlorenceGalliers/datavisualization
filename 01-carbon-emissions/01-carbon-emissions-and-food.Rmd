...
plot1 <- ggplot(meat_edit, 
  ...
  coord_flip() +
  labs(title = "Argentinian Beef emissions are over 
30x higher than consumption levels",
       subtitle = "Points show the difference between the consumption of meat (kg/person/year) 
and the carbon emissions produced (kg CO2/person/year) worldwide. The further 
to the right a point is, the higher the emissions are in comparison to consumption.",
x = "Difference") +
  theme(plot.title = element_text(family = "Arial Black", size = 14, colour = "#840a35"),
